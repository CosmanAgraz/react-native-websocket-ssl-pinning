...
exports.terminateWebSocket = exports.sendWebSocketMessage = exports.removeCookieByName = exports.getCookies = exports.fetch = exports.eventEmitter = exports.closeWebSocket = void 0;
...
const terminateWebSocket = () => {
  WebSocketSslPinning.terminateWebSocket('Client initiated closure', (error, successMessage) => {
    if (error) {
